...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['add_user'])) {
    ...
    $password_hashed = password_hash($password, PASSWORD_DEFAULT); // Cifra la contraseña

    $sql = "INSERT INTO usuarios (nombre, email, role, password) VALUES ('$nombre', '$email', '$role', '$password_hashed')";
    if ($conn->query($sql) === TRUE) {
...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['update_user'])) {
    ...
    if (!empty($_POST['password'])) {
        ...
        $password_hashed = password_hash($password, PASSWORD_DEFAULT); // Cifra la nueva contraseña
        $sql = "UPDATE usuarios SET nombre='$nombre', email='$email', role='$role', password='$password_hashed' WHERE id='$id'";
    } else {
                                    ...
                                    <form action='gestion_usuarios.php' method='POST'>
                                        <div class='modal-body'>
                                            ...
                                            <div class='form-group'>
                                                ...
                                                <input type='password' class='form-control' name='password' placeholder='Dejar en blanco si no desea cambiar'>
                                            </div>
                                        </div>
